...
**Depending on the subsetting of reactions from ORAdb you can use the following (choose only one option):**
...
During this task the omplete list of files generated in the output_folder are:
...
- [GP_rules.json](GP_rules.json) : A copy of the Gene-Protein-Reaction rules (for backtracking).
